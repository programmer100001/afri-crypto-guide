...
export const Header = () => {
  ...
  const localInsightsItems = [
    ...
    { label: "Kenya News & Updates", href: "#kenya-news", description: "Local crypto news" },
  ];
          ...
          {!isMobile ? (
            <div className="flex items-center space-x-6">
              <NavigationMenu>
                <NavigationMenuList>
                  <NavigationMenuItem>
                    <a href="#home" className="text-slate-300 hover:text-white transition-colors px-3 py-2">
                      Home
                    </a>
                  </NavigationMenuItem>
